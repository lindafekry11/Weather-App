...
const previewCity = (searchResult) => 
{
  ...
  router.push
    ({
      name: "cityView",
      params: { state: state.replaceAll(" ", ""), city: city }, // replace space to empty string
      query: 
      {
...
const getSearchResults = () => {
  clearTimeout(querytTimeout.value)
  querytTimeout.value = setTimeout( async () => {
